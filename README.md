...
This processor uses OpenAI models to transform records based on a given prompt. It takes the content from a specified field in the record, sends it to OpenAI's API with a developer-defined message, and replaces the original content with the generated response.
